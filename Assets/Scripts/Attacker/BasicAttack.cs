...
//        RaycastHit2D hit = Physics2D.Raycast((Vector2)transform.position, lastMoveAttempt, layerMask);
...
//        }
        ...
        RaycastHit2D hit = Physics2D.Raycast(origin: transform.position,
                                               direction:lastMoveAttempt,
